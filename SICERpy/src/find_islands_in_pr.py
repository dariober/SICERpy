...
import BED
import SeparateByChrom # GenomeData
...
def find_region_above_threshold_from_file(Islands_file, chromList, islands_minimum_tags, out_islands_file):
    bed_vals = BED.BED(chromList, Islands_file, "BED_GRAPH");
